							...
							<div class="row">
								<div class="col-md-4">
									<div class="card">
										...
										<div class="card-body">
											 @if ($about && $about->gambar_about)
												<img src="{{ asset('storage/' . $about->gambar_about) }}" class="img-fluid d-block mx-auto" alt="">
                                    		@else
									...
									<div class="card">
										...
										<div class="card-body">
											@if ($about && $about->bagan_organisasi)
												<img src="{{ asset('storage/' . $about->bagan_organisasi) }}" class="img-fluid d-block mx-auto" alt="">
                                    		@else
                                    		    <p>No image available yet.</p>
                                    		@endif
										</div>
        							...
        							<div class="modal-content">
            							...
            							<div class="modal-body">
											...
											<form action="{{ route('admin.updateAboutUs') }}" method="post" enctype="multipart/form-data">
												...
												<div class="form-group">
													<label for="gambar_about">Gambar Wilayah</label>
											...
											@else
											<form action="{{ route('admin.addAboutUs') }}" method="post" enctype="multipart/form-data">
												@csrf
												<div class="form-group">
													<label for="visi">Visi*</label>
													<textarea name="visi" class="form-control" id="visi" cols="50" rows="4" required></textarea>					
												</div>
												<div class="form-group">
													<label for="misi">Misi*</label>
													<textarea name="misi" class="form-control" id="misi" cols="50" rows="4" required></textarea>					
												</div>
												<div class="form-group">
													<label for="gambar_about">Gambar Wilayah</label>
													<input type="file" class="form-control-file" name="gambar_about" id="gambar_about" accept="image/*" required>
                								</div>
												<div class="form-group">
													<label for="bagan_organisasi">Bagan Organisasi</label>
													<input type="file" class="form-control-file" name="bagan_organisasi" id="bagan_organisasi" accept="image/*" required>
                								</div>
												<button type="submit" class="btn btn-primary form-control">Save changes</button>
											</form>
											@endif
								...
								<div class="col-md-8">
									<div class="card">
										...
										<div class="card-body">
											...
											<p>Jumlah Penduduk : {{ $total_jenis_kelamin->laki_laki + $total_jenis_kelamin->perempuan }} Jiwa</p>
										</div>
									</div>
								</div>
							</div>
        							...
        							<div class="modal-content">
            							...
            							<div class="modal-body">
											<form action="{{ route('admin.updateProfil', $wilayaheach->id_wilayah) }}" method="post" enctype="multipart/form-data">
												@csrf
												<div class="form-group">
													<label for="gambar_wilayah">Gambar Wilayah</label>
        				            ...
        				            <div class="col-md-6 col-lg-3">
        				                <div class="guide-item">
        				                    ...
        				                    <div class="guide-title text-center rounded-bottom p-2">
        				                        <div class="guide-title-inner" style="min-height: 200px">
													...
													<a href="" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal_confirmation_{{ $perangkat->id_perangkat }}">Remove</a>
															...
															<form action="{{ route('admin.updatePerangkat', $perangkat->id_perangkat)}}" method="post" enctype="multipart/form-data">
																...
																<div class="form-group">
									        						...
									        						<select name="nama_wilayah" class="form-control">
																		...
																		@foreach($wilayah as $wilayahUser)
									        						    <option value="{{ $wilayahUser->id_wilayah }}" {{ $perangkat->id_wilayah == $wilayahUser->id_wilayah ? 'selected' : '' }}>{{ $wilayahUser->nama_wilayah }}</option>
																		@endforeach
									        						</select>
									        					</div>
																<div class="form-group">
										...
										<div class="modal fade" id="modal_confirmation_{{ $perangkat->id_perangkat }}" tabindex="-1" aria-labelledby="modalTitle" aria-hidden="true">
   											<div class="modal-dialog">
    											<div class="modal-content">
    												<div class="modal-header">
    												...
    												<div class="modal-body">
														...
														<div class="d-flex justify-content-end">
															...
															<a href="{{ route('admin.removePerangkat', $perangkat->id_perangkat) }}" class="btn btn-danger ml-3">Hapus</a>
														</div>
										            </div>
										        </div>
										    </div>
        						...
        						<div class="modal-content">
            						...
            						<div class="modal-body">
										<form action=" {{ route('admin.createPerangkat') }}" method="post" enctype="multipart/form-data">
											...
											<div class="form-group">
												<label for="gambar_perangkat">Gambar*</label>
												<input type="file" class="form-control-file" name="gambar_perangkat" id="gambar_perangkat" required>
                							</div>
