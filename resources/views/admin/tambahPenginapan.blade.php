			...
			<div class="main-panel">
				<div class="container-fluid">
					...
					<div class="d-flex justify-content-between align-items-center">
						<h4 class="page-title mt-2">Form Tambah Penginapan</h4>
					</div>
							...
							<div class="col">
								<div class="card">
									<div class="card-body">
                                        ...
                                        <form action="{{ route('admin.createPenginapan') }}" method="post" enctype="multipart/form-data">
									    	@csrf
									    	...
									    	<div class="form-group row">
                                                <div class="col col-md-6">
									    		    ...
									    		    <input type="text" class="form-control" name="nama_penginapan" id="nama_penginapan" required>
                                                </div>
                                                <div class="col col-md-6">
                                            ...
                                            <div class="form-group">
												...
												<input type="text" name="estimasi_jarak" id="estimasi_jarak" class="form-control" required>
											</div>
											<div class="form-group">
                                            ...
                                            <div class="form-group">
									    		...
									    		<textarea name="fasilitas" class="form-control" id="fasilitas" cols="50" rows="4" required></textarea>					
									    	</div>
											<div class="form-group">
									    	...
									    	<div class="form-group">
									    		...
									    		<input type="file" class="form-control-file" name="gambar_penginapan" id="gambar_penginapan" accept="image/*" required>
                					    	</div>
