			...
			<div class="main-panel">
				<div class="container-fluid">
					...
					<div class="d-flex justify-content-between align-items-center">
						<h4 class="page-title mt-2">Form Tambah Berita</h4>
					</div>
					...
					<div class="row">
							<div class="col">
								<div class="card">
									<div class="card-body">
                                        <div class="row">
                                            <form action="{{ route('admin.createBerita') }}" method="post" enctype="multipart/form-data" class="row">
										    	@csrf
                                                ...
                                                <div class="form-group row text-center ml-2">
                                                    ...
                                                    <button type="button" class="btn btn-primary mb-4 mt-3" onclick="document.getElementById('gambar_berita').click()">Tambah Thumbnail</button>
										    	    <input type="file" class="form-control-file" name="gambar_berita" accept="image/*" style="display:none;" onchange="previewImage(event)" id="gambar_berita" required>
                						    	</div>
                                                </div>
